...
// ເປີດຈາກປຸ່ມ (i) ເທິງ header ຄືກັບ request ຂໍລາຍເຊັນ (Lucky 19/07 ຮອບ 2 — ບໍ່ແມ່ນ card ໃນໜ້າ)
...
export function ReqActivityModal({ req, chain = [], createLabel = 'ສ້າງຄຳຂໍ', onClose }) {
  ...
  // modal ດຽວກັບ DocDetail (i) — modal-head + dd-audit
  return (
...
export function RequestDetailBody({ req, kind, me, onPreview, onComment, onEditComment, onDeleteComment }) {
  ...
  return (<>
    ...
    {/* ປະຫວັດກິດຈະກຳ ຍ້າຍໄປປຸ່ມ (i) ເທິງ header ຂອງແຕ່ລະໜ້າ detail (Lucky 19/07 ຮອບ 2) */}
